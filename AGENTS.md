...
_Auto-generated 2026-09-02 21:32 · 0 verified memories · default branch `main`._
...
_No memories captured yet — run `omni-memory build` to bootstrap, or work a session with the layer enabled._
