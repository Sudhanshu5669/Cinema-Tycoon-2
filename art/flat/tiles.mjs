...
/**
 * ROOM_HALL and ROOM_FLAT are 80 x 40 -- FIVE tiles wide, spanning two window
 * bays rather than sitting behind one.
 *
 * That is the whole point of them. Every room used to be centred on its own
 * opening, which made each window a sealed diorama: nothing could cross
 * between two windows, so an upper floor read as a row of separate lit boxes
 * instead of a building with a floor in it. In the reference it is one
 * continuous interior seen through several holes -- the staircase starts in
 * one bay and climbs up behind the mullion into the next, and the dado rail
 * runs unbroken at the same height across both. That single continuous
 * horizontal is what tells the eye there is a floor back there.
 *
 * So a building can now declare an `interior` (renderer.js) -- art placed in
 * face space, with the openings as holes into it -- and these are what it
 * places. Five tiles is what a two-bay pair actually needs: windows at `fx`
 * and `fx + 2` span 56px, and the strip sits at `fx - 1` so there is real
 * overhang on both sides for the parallax to slide against. The 32 x 40 singles below stay for buildings with isolated windows,
 * and are drawn in the same language so the two can share a wall.
 *
 * All of them are ROOM_PALETTE, not TILE_PALETTE, and carry their own light
 * direction in the paint -- see the note on ROOM_PALETTE for why a room has
 * to light itself.
 */
export const ROOM_HALL = [
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwrwwwbwwwwwbwwwwwbwwwwww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwrrRwwwbwwwwwbwwwwwbwwwwww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwrRRwwwwbwwwwwbwwwwwbwwwwww',
  'wwwwwwfffffffffffffffffwwwwwwwwwwwwwwwwwwwwwwwwwwwwwrrRbwwwwwbwwwwwbwwwwttttttww',
  'wwwwwwfAAAAAAAAAAAAAAafwwwwwwwwwwwwwwwwwwwwwwwwwwwwrRRwbwwwwwbwwwwwbwwwwTTTTTTww',
  'wwwwwwfAAAAAAAAAAAAAaafwwwwwwwwwwwwwwwwwwwwwwwwwwrrRwwwbwwwwwbwwwwwbwwwwTTTTTTww',
  'wwwwwwfAAAAAAAAAAAAaaafwwwwwwwwwwwwwwwwwwwwwwwwwrRRwwwwbwwwwwbwwwwwbwwwwssssssww',
  'wwwwwwfAAAAAAAAAAAaaaafwwwwwwwwwwwwwwwwwwwwwwwrrRbwwwwwbwwwwwbwwwwttttttssssssww',
  'WWWWWWfAAAAAAAAAAaaaaafWWWWWWWWWWWWWWWWWWWWWWrRRWbWWWWWbWWWWWbWWWWTTTTTTssssssWW',
  'WWWWWWfAAAAAAAAAaaaaaafWWWWWWWWWWWWWWWWWWWWrrRWWWbWWWWWbWWWWWbWWWWTTTTTTssssssWW',
  'WWWWWWfAAAAAAAAaaaaaaafWWWWWWWWWWWWWWWWWWWrRRWWWWbWWWWWbWWWWWbWWWWssssssssssssWW',
  'WWWWWWfAAAAAAAaaaaaaaafWWWWWWWWWWWWWWWWWrrRbWWWWWbWWWWWbWWWWttttttssssssssssssWW',
  'WWWWWWfAAAAAAaaaaaaaaafWWWWWWWWWWWWWWWWrRRWbWWWWWbWWWWWbWWWWTTTTTTssssssssssssWW',
  'WWWWWWfAAAAAaaaaaaaaaafWWWWWWWWWWWWWWrrRWWWbWWWWWbWWWWWbWWWWTTTTTTssssssssssssWW',
  'WWWWWWfAAAAaaaaaaaaaaafWWWWWWWWWWWWWrRRWWWWbWWWWWbWWWWWbWWWWssssssssssssssssssWW',
  'nnnnnnfAAAaaaaaaaaaaaafnnnnnnnnnnnrrRbnnnnnbnnnnnbnnnnttttttssssssssssssssssssnn',
  'nnnnnnfffffffffffffffffnnnnnnnnnnrRRnbnnnnnbnnnnnbnnnnTTTTTTssssssssssssssssssnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnrrRnnnbnnnnnbnnnnnbnnnnTTTTTTssssssssssssssssssnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnrRRnnnnbnnnnnbnnnnnbnnnnssssssssssssssssssssssssnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnRbnnnnnbnnnnnbnnnnttttttssssssssssssssssssssssssnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnbnnnnnbnnnnnbnnnnTTTTTTssssssssssssssssssssssssnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnbnnnnnbnnnnnbnnnnTTTTTTssssssssssssssssssssssssnn',
  'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrbrrrrrbrrrrrbrrrrssssssssssssssssssssssssssssssrr',
  'dddddddddddddddddddddddddddddddbdddddbddddttttttssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbdddddbddddTTTTTTssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbdddddbddddTTTTTTssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbdddddbddddssssssssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbddddttttttssssssssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbddddTTTTTTssssssssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbddddTTTTTTssssssssssssssssssssssssssssssssssssdd',
  'dddddddddddddddddddddddddddddddbddddssssssssssssssssssssssssssssssssssssssssssdd',
  'ddddddddddddddddddddddddddddddttttttssssssssssssssssssssssssssssssssssssssssssdd',
  'ddddddddddddddddddddddddddddddTTTTTTssssssssssssssssssssssssssssssssssssssssssdd',
  'ddddddddddddddddddddddddddddddTTTTTTssssssssssssssssssssssssssssssssssssssssssdd',
  'DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDssssssssssssssssssssssssssssssssssssssssssssssssDD',
  'DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDssssssssssssssssssssssssssssssssssssssssssssssssDD',
  'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr',
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
];
export const ROOM_FLAT = [
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
  ...
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwfffffffffffffffwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwfAAAAAAAAAAAAAfwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwfAAAAAAAAAAAAafwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwOOOOOOOOOOOOOOOOOOOwwwww',
  'wwwwwwwfAAAAAAAAAAAaafwwwwwwwwwwwLLLLLLLwwwwwwwwwwwwwwwwOOOOOOOOOOOOOOOOOOOwwwww',
  'WWWWWWWfAAAAAAAAAAaaafWWWWWWWWWWWLlllllLWWWWWWWWWWWWWWWWOOoooooooooooooooooWWWWW',
  'WWWWWWWfAAAAAAAAAaaaafWWWWWWWWWWWLlllllLWWWWWWWWWWWWWWWWOOoooooooooooooooooWWWWW',
  'WWWWWWWfAAAAAAAAaaaaafWWWWWWWWWWWLlllllLWWWWWWWWWWWWWWWWOOoooooooooooooooooWWWWW',
  'WWWWWWWfAAAAAAAaaaaaafWWWWWWWWWWWLlllllLWWWWWWWWWWWWWWWWOOoooooooooooooooooWWWWW',
  'WWWWWWWfAAAAAAaaaaaaafWWWWWWWWWWWLlllllLWWWWWWWaaaaaWWWWOOoooooooooooooooooWWWWW',
  'WWWWWWWfAAAAAaaaaaaaafWWWWWWWWWWWLlllllLWWWWWWWaaaaaWWWWOOoooooooooooooooooWWWWW',
  'WWWWWWWfAAAAaaaaaaaaafWWWWWWWWWWWLlllllLWWWWWWWaaaaaWWWWOOoooooooooooooooooWWWWW',
  'nnnnnnnfAAAaaaaaaaaaafnnnnnnnnnnnLLLLLLLnnnnnAAAAAAAAAnnOOooooooooooooooooonnnnn',
  'nnnnnnnfffffffffffffffnnnnnnrrrrrrrrrrrrrrrrrAAAAAAAAAnnOOooooooooooooooooonnnnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnrrrrrrrrrrrrrrrrrAAAAAAAAAnnOOooooooooooooooooonnnnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnrrrrrrrrrrrrrrrrrAAAAAAAAAnnOOooooooooooooooooonnnnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnOOOOOOOOOOOOOOOnAAAAAAAAAnnOOooooooooooooooooonnnnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnOOOOOOOOOOOOOOOnAAAAAAAAAnnOOolloooooooooooooonnnnn',
  'nnnnnnnnnnnnnnnnnnnnnnnnnnnnnOOOOOOOOOOOOOOOnnnaaaaannnnOOolloooooooooooooonnnnn',
  'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrOOOOOOOOOOOOOOOrrraaaaarrrrOOolloooooooooooooorrrrr',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOdddaaaaaddddOOollooooooooooooooddddd',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOddOaaaaaOdddOOoooooooooooooooooddddd',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOddOOOOOOOdddOOoooooooooooooooooddddd',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOddOOOOOOOdddOOoooooooooooooooooddddd',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOddOOOOOOOdddOOoooooooooooooooooddddd',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOddOOOOOOOdddOOoooooooooooooooooddddd',
  'dddddddddddddddddddddddddddddOOOOOOOOOOOOOOOddOOOOOOOdddOOoooooooooooooooooddddd',
  'ddddddddddddddddddddddddddddddddddddddddddddddOOOOOOOdddOOoooooooooooooooooddddd',
  'ddddddddddddddddddddddddddddddddddddddddddddddOOOOOOOdddOOoooooooooooooooooddddd',
  'ddddddddddddddddddddddddddddddddddddddddddddddOOOOOOOdddOOoooooooooooooooooddddd',
  'ddddddddddddddddddddddddddddddddddddddddddddddOOOOOOOdddOOoooooooooooooooooddddd',
  'DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDOOOOOOODDDOOoooooooooooooooooDDDDD',
...
export const ROOM_STAIR = [
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
  'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwrww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwrrRww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwrRRwww',
  'wwwwwwwwwwwwwwwwwwwwwwwwrrRbwwww',
  'wwwwwwwwwwwwwwwwwwwwwwwrRRwbwwww',
  'wwwwwwwwwwwwwwwwwwwwwrrRwwwbwwww',
  'wwwwwwwwwwwwwwwwwwwwrRRwwwwbwwww',
  'wwwwwwwwwwwwwwwwwwrrRbwwwwwbwwww',
  'WWWWWWWWWWWWWWWWWrRRWbWWWWWbWWWW',
  'WWWWWWWWWWWWWWWrrRWWWbWWWWWbWWWW',
  'WWWWWWWWWWWWWWrRRWWWWbWWWWWbWWWW',
  'WWWWWWWWWWWWrrRbWWWWWbWWWWWbWWWW',
  'WWWWWWWWWWWrRRWbWWWWWbWWWWWbWWWW',
  'WWWWWWWWWrrRWWWbWWWWWbWWWWWbWWWW',
  'WWWWWWWWrRRWWWWbWWWWWbWWWWWbWWWW',
  'nnnnnnrrRbnnnnnbnnnnnbnnnntttttt',
  'nnnnnrRRnbnnnnnbnnnnnbnnnnTTTTTT',
  'nnnrrRnnnbnnnnnbnnnnnbnnnnTTTTTT',
  'nnrRRnnnnbnnnnnbnnnnnbnnnnssssss',
  'nnRbnnnnnbnnnnnbnnnnttttttssssss',
  'nnnbnnnnnbnnnnnbnnnnTTTTTTssssss',
  'nnnbnnnnnbnnnnnbnnnnTTTTTTssssss',
  'rrrbrrrrrbrrrrrbrrrrssssssssssss',
  'dddbdddddbddddttttttssssssssssss',
  'dddbdddddbddddTTTTTTssssssssssss',
  'dddbdddddbddddTTTTTTssssssssssss',
  'dddbdddddbddddssssssssssssssssss',
  'dddbddddttttttssssssssssssssssss',
  'dddbddddTTTTTTssssssssssssssssss',
  'dddbddddTTTTTTssssssssssssssssss',
  'dddbddddssssssssssssssssssssssss',
  'ddttttttssssssssssssssssssssssss',
  'ddTTTTTTssssssssssssssssssssssss',
  'ddTTTTTTssssssssssssssssssssssss',
  'DDssssssssssssssssssssssssssssss',
  'DDssssssssssssssssssssssssssssss',
...
export const ROOM_LAMP = [
  ...
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwfffffffffffffwwwwwwwwwwwwwww',
  'wwwwfAAAAAAAAAAAfwwwwwwwwwwwwwww',
  'wwwwfAAAAAAAAAAafwwwwwwwwwwwwwww',
  'wwwwfAAAAAAAAAaafwwwwwwwwwwwwwww',
  'wwwwfAAAAAAAAaaafwwwwwwwwwwwwwww',
  'WWWWfAAAAAAAaaaafWWWLLLLLWWWWWWW',
  'WWWWfAAAAAAaaaaafWWWLlllLWWWWWWW',
  'WWWWfAAAAAaXXXXXfWWWLlllLWWWWWWW',
  'WWWWfAAAAaaXXXXXfWWWLlllLWWWWWWW',
  'WWWWfAAAaaXXXXXXXWWWLlllLWWWWWWW',
  'WWWWfAAaaaXXXXXXXWWWLlllLWWWWWWW',
  'WWWWffffffXXXXXXXWWWLlllLWWWWWWW',
  'nnnnnnnnnnXXXXXXXnnnLlllLnnnnnnn',
  'nnnnnnnnnnXXXXXXXnnnLLLLLnnnnnnn',
  'nnnnnnnnnnXXXXXXXnnnnnnnnnnnnnnn',
  'nnnnnnrrrrXXXXXXXrrrrrrrrnnnnnnn',
  'nnnnnnrrrrXXXXXXXrrrrrrrrnnnnnnn',
  'nnnnnnrrrrXXXXXXXrrrrrrrrnnnnnnn',
  'nnnnnnnOOOXXXXXXXOOOOOOOnnnnnnnn',
  'rrrrrrrOOOOOOOOOOOOOOOOOrrrrrrrr',
  'dddddddOOOOOOOOOOOOOOOOOdddddddd',
  'dddddddOOOOOOOOOOOOOOOOOdddddddd',
  'dddddddOOOOOOOOOOOOOOOOOdddddddd',
  'dddddddOOOOOOOOOOOOOOOOOdddddddd',
  'dddddddOOOOOOOOOOOOOOOOOdddddddd',
...
export const ROOM_PLANT = [
  ...
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww',
  'wwwwwwwwwwwwwwwwwwrrrrrrrrrrrwww',
  'wwwwwwwwwwwwwwwwwwrrrrrrrrrrrwww',
  'WWWWWWWWWWWWWWWWWWrrrrrrrrrrrWWW',
  'WWWWWWWWWWWWWWWWWWWoooooooooWWWW',
  'WWWWWWWWWWWWWWWWWWWoooooooooWWWW',
  'WWWWWWWWWWWWWWWWWWWoooooooooWWWW',
  'WWWWWWWWWWWWWWWWWWWoooooooooWWWW',
  'WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW',
  ...
  'nnnnnaaaaannnnnnnnnnnnnnnnnnnnnn',
  'nnnnnaaaaannnnnnnnnnnnnnnnnnnnnn',
  'nnnAAAAAAAAAnnnnnnnnnnnnnnnnnnnn',
  'nnnAAAAAAAAAnnnnnnnnnnnnnnnnnnnn',
  'nnnAAAAAAAAAnnnnnnnnnnnnnnnnnnnn',
  'nnnAAAAAAAAAnnnnnnnnnnnnnnnnnnnn',
  'rrrAAAAAAAAArrrrrrrrrrrrrrrrrrrr',
  'dddddaaaaadddddddddddddddddddddd',
  'ddddOaaaaaOddddddddddddddddddddd',
  'ddddOOOOOOOddddddddddddddddddddd',
  'ddddOOOOOOOddddddddddddddddddddd',
  'ddddOOOOOOOddddddddddddddddddddd',
  'ddddOOOOOOOddddddddddddddddddddd',
  'ddddOOOOOOOddddddddddddddddddddd',
...
export const FEATURES = {
  ...
  roomHall: ROOM_HALL, roomFlat: ROOM_FLAT,
