 ...
 */
const RADIUS = { window: 110, marquee: 300, streetlamp: 220, lobby: 150, tv: 120, fixture: 110, lantern: 120, bulb: 110, led: 120, cafe: 115 };
 ...
 */
const MERGE_DIST = { window: 400, fixture: 250, lantern: 300, bulb: 300, led: 300, cafe: 300, streetlamp: 0, marquee: 0, lobby: 0, tv: 0 };
 ...
 */
const MERGE_RADIUS_BOOST_MAX = { window: 220, fixture: 90, lantern: 90, bulb: 90, led: 90, cafe: 90, streetlamp: 40, default: 48 };
...
export class LightingLayer {
  ...
  constructor(scene, points) {
    ...
    this.lights = points.map((p) => new Light({
      ...
      castsShadow: p.castsShadow !== false,
    }));
