 ...
 */
const RADIUS = { window: 48, marquee: 118, streetlamp: 78, lobby: 80, tv: 54, lantern: 40, bulb: 36 };
 ...
 */
const PEAK = { window: 0.16, marquee: 0.24, streetlamp: 0.21, lobby: 0.13, tv: 0.19, lantern: 0.22, bulb: 0.18 };
